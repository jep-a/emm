...
function ChannelService.PacketToChannels(packet)
    ...
    for channel_id, channel_data in pairs(channel_info) do
			...
			if channel_data.voice then
					new_channel = ChannelService.CreateVoiceChannel(channel_id, channel_data.private, Player(channel_data.host))
			else
					new_channel = ChannelService.CreateTextChannel(channel_id, channel_data.private, Player(channel_data.host))
			end
